...
export function GroupCipher_Decrypt(name: SenderKeyName, store: unknown, message: Buffer): Promise<Buffer>;
export function GroupCipher_Encrypt(name: SenderKeyName, store: unknown, message: Buffer): Promise<Buffer>;
...
export function SenderCertificate_GetSenderUuid(obj: SenderCertificate): string;
...
export function SenderKeyDistributionMessage_Create(name: SenderKeyName, store: unknown): Promise<SenderKeyDistributionMessage>;
...
export function SenderKeyDistributionMessage_Process(name: SenderKeyName, msg: SenderKeyDistributionMessage, store: unknown): Promise<void>;
