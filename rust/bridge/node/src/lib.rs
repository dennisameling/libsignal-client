...
impl<'a> NodeSenderKeyStore<'a> {
    ...
    async fn do_get_sender_key(
        ...
        .then(|cx, result| match result {
            Ok(value) => {
                match value.downcast::<JsBox<crate::node::DefaultFinalize<SenderKeyRecord>>, _>(cx)
                {
...
/// ts: export function SenderKeyDistributionMessage_Create(name: SenderKeyName, store: unknown): Promise<SenderKeyDistributionMessage>
...
#[allow(non_snake_case)]
/// ts: export function SenderKeyDistributionMessage_Process(name: SenderKeyName, msg: SenderKeyDistributionMessage, store: unknown): Promise<void>
...
#[allow(non_snake_case)]
/// ts: export function GroupCipher_Encrypt(name: SenderKeyName, store: unknown, message: Buffer): Promise<Buffer>
...
#[allow(non_snake_case)]
/// ts: export function GroupCipher_Decrypt(name: SenderKeyName, store: unknown, message: Buffer): Promise<Buffer>
